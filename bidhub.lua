...
if _G.Setting_table.Save_Member then
	getgenv()['BIDHUB '] = game.Players.LocalPlayer.Name
	print("Save Member")
elseif _G.Setting_table.Save_All_Member then
	getgenv()['BIDHUB '] = "AllMember"
...
Check_Setting(getgenv()['BIDHUB '])
Get_Setting(getgenv()['BIDHUB '])

_G.Setting_table.Key = _G.wl_key
Update_Setting(getgenv()['BIDHUB '])
